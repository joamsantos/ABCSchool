...
public record SchoolPermission(
    ...
    string Description, 
    string Group,
    bool IsBasic = false, bool IsRoot = false)
{
...
public static class SchoolPermissions
{
    ...
    [
        ...
        new SchoolPermission(SchoolAction.UpgradeSubscription, SchoolFeature.Tenants, "Upgrade Tenants Subscription", "Tenancy", IsRoot: true),
        ...
        new SchoolPermission(SchoolAction.RefreshToken, SchoolFeature.Tokens, "Generate Refresh Token", "Academics", IsBasic: true)
    ];
